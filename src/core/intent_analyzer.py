...
class IntentAnalyzer:
    def __init__(self):
        ...
        self.context_limits = {
            IntentCategory.DEFINITION: {"max_chars": 36000,
                                        "base_nodes": 4,
                                        "category_nodes": 3,
                                        "fill_nodes": 2},
            IntentCategory.IMPLEMENTATION: {"max_chars": 30000,
                                            "base_nodes": 5,
                                            "category_nodes": 4,
                                            "fill_nodes": 3},
            IntentCategory.USAGE: {"max_chars": 24000,
                                   "base_nodes": 3,
                                   "category_nodes": 4,
                                   "fill_nodes": 2},
            IntentCategory.TESTING: {"max_chars": 30000,
                                     "base_nodes": 4,
                                     "category_nodes": 4,
                                     "fill_nodes": 3},
            IntentCategory.EXCEPTION: {"max_chars": 28000,
                                       "base_nodes": 4,
                                       "category_nodes": 3,
                                       "fill_nodes": 2},
            IntentCategory.GENERAL: {"max_chars": 16000,
                                     "base_nodes": 3,
                                     "category_nodes": 2,
                                     "fill_nodes": 2},
        }
